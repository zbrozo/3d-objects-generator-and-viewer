...
../generator --n 60 --o composite8 --t composite --c0 star --p0 5 80 72 0

#    ../generator --o square --t composite --c0 square --p0 50
    
cd ..
echo "Start viewer"
./viewer objects composite8  cube4 composite6 composite7 thorus4 thorus5 thorus6 thorus7 composite4 tetrahedron1 tetrahedron3
