...
../generator --n 60 --o composite7 --t composite --c0 csign --p0 5 100 60 0 0 20 --f0 0 0 0 0 0 0 10 0 0 --c1 csign --p1 5 100 60 0 0 20 --f1 0 0 0 90 180 0 10 0 0

#    ../generator --o square --t composite --c0 square --p0 50
    
cd ..
echo "Start viewer"
./viewer objects cube1 cube4 composite6 composite7 thorus4 thorus5 thorus6 thorus7 composite4 tetrahedron1 tetrahedron3
