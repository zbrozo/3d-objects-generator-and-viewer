  ...
  const ParamsMap& params) const
{
  ...
  return std::make_unique<Thorus>(
    ...
    GetObligatoryInt(foundParams, 2),
    GetObligatoryInt(foundParams, 3),
    GetOptionalUnsignedInt(foundParams, 4),
    GetOptionalInt(foundParams, 5),
    GetOptionalInt(foundParams, 6),

    GetOptionalDouble(foundSinusParams, 0),
    GetOptionalDouble(foundSinusParams, 1),
    GetOptionalDouble(foundSinusParams, 2),
    GetOptionalDouble(foundSinusParams, 3),
    GetOptionalDouble(foundSinusParams, 4),
    GetOptionalDouble(foundSinusParams, 5),
    GetOptionalDouble(foundSinusParams, 6),
    GetOptionalDouble(foundSinusParams, 7),
    GetOptionalDouble(foundSinusParams, 8),
    GetOptionalDouble(foundSinusParams, 9),
    GetOptionalDouble(foundSinusParams, 10),
    GetOptionalDouble(foundSinusParams, 11),
    preferTriangles);
}
